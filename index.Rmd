...
author: "High Honorable League Commissioner Michael"
date: "`r Sys.Date()`"
output:
  html_document:
    toc: true
...
- 3/27 - Opening Day was Wednesday, and the first score update of the season was today. If a player doesn't show up on your roster with any stats - they haven't played in a game yet.... I will be buying a web domain to make the site easier to find, check back soon for more info on that.
...
- 3/22 - The Commissioner adjusted the points formula for 3rd and 4th place in a statistical category. First place in a stat - 5pts, second - 3pts, third - 2pts, fourth - 1pt, fifth - 0pts.
